...
const byte TIPO_MODULO=0x22;
const byte NUMERO_FUNCIONES=0x05;
const byte FUNCIONES_MODULO[NUMERO_FUNCIONES]={SENSOR_HUMO,SENSOR_GAS,SENSOR_TEMPERATURA_HUMEDAD,SENSOR_FUEGO,SALIDAS_CONTROLADAS};
